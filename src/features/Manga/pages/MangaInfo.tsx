    ...
    <div className="w-4/5 mx-auto bg-white">
      ...
      <div>
        ...
        <div className="flex">
          ...
          <div className="p-5">
            <dl>
              <div className="grid mb-2 grid-cols-4 gap-2">
              ...
              <div className="grid mb-2 grid-cols-[1fr,2fr,1fr] gap-2">
            ...
            <div className="flex">
              ...
              <button className="p-2 bg-yellow-600 mr-1 rounded-md text-white">Đọc mới nhất</button>
            </div>
          </div>
        </div>
        <div className="p-5">
